...
# notion-cli-local-llm

**Notion CLI(`ntn`)로 지식베이스를 다룰 때, Agent가 같은 함정을 반복하지 않도록 가르치는 Agent Skill입니다.**

Cursor, Claude Code, Codex 모두 지원합니다.
...
| 도구 | 프로젝트 경로 | 개인 경로 |
|------|---------------|-----------|
| Cursor | `.cursor/skills/notion-cli-local-llm/` | `~/.cursor/skills/notion-cli-local-llm/` |
| Claude Code | `.claude/skills/notion-cli-local-llm/` | `~/.claude/skills/notion-cli-local-llm/` |
| Codex | `.agents/skills/notion-cli-local-llm/` | `~/.agents/skills/notion-cli-local-llm/` |

**개인 스킬로 쓰는 경우:**

```bash
# Cursor
mkdir -p ~/.cursor/skills/notion-cli-local-llm
cp .cursor/skills/notion-cli-local-llm/SKILL.md ~/.cursor/skills/notion-cli-local-llm/

# Claude Code
mkdir -p ~/.claude/skills/notion-cli-local-llm
cp .claude/skills/notion-cli-local-llm/SKILL.md ~/.claude/skills/notion-cli-local-llm/

# Codex
mkdir -p ~/.agents/skills/notion-cli-local-llm
cp .agents/skills/notion-cli-local-llm/SKILL.md ~/.agents/skills/notion-cli-local-llm/
```
...
| 도구 | 수동 호출 |
|------|-----------|
| Cursor | `/notion-cli-local-llm` |
| Claude Code | `/notion-cli-local-llm` |
| Codex | `/skills` 또는 `$notion-cli-local-llm` |
...
```
.cursor/skills/notion-cli-local-llm/SKILL.md   # Cursor용
.claude/skills/notion-cli-local-llm/SKILL.md   # Claude Code용 (ntn doctor 자동 주입)
.agents/skills/notion-cli-local-llm/SKILL.md   # Codex용
```
...
skill_paths:
  cursor.project=.cursor/skills/notion-cli-local-llm/SKILL.md
  cursor.user=~/.cursor/skills/notion-cli-local-llm/SKILL.md
  claude.project=.claude/skills/notion-cli-local-llm/SKILL.md
  claude.user=~/.claude/skills/notion-cli-local-llm/SKILL.md
  codex.project=.agents/skills/notion-cli-local-llm/SKILL.md
  codex.user=~/.agents/skills/notion-cli-local-llm/SKILL.md

install.repo=clone repo; skills ship in paths above
install.user.cursor=mkdir -p ~/.cursor/skills/notion-cli-local-llm && cp .cursor/skills/notion-cli-local-llm/SKILL.md ~/.cursor/skills/notion-cli-local-llm/
install.user.claude=mkdir -p ~/.claude/skills/notion-cli-local-llm && cp .claude/skills/notion-cli-local-llm/SKILL.md ~/.claude/skills/notion-cli-local-llm/
install.user.codex=mkdir -p ~/.agents/skills/notion-cli-local-llm && cp .agents/skills/notion-cli-local-llm/SKILL.md ~/.agents/skills/notion-cli-local-llm/

invoke.cursor=/notion-cli-local-llm
invoke.claude=/notion-cli-local-llm
invoke.codex=/skills|$notion-cli-local-llm
